...
Plugin [Dalamud](https://goatcorp.github.io/) qui synchronise automatiquement ta progression FFXIV avec [XIVDash](https://xivdash.fr) — quêtes complétées, niveaux de jobs — à chaque changement de zone.
...
- Un compte sur [XIVDash](https://xivdash.fr)
...
4. Renseigne l'URL (`https://xivdash.fr`) et colle le token
